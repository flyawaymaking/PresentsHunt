...
Плагин для Minecraft серверов на Paper 1.21+, который добавляет увлекательную охоту за подарками (предметами события) с разными тематическими режимами. Игроки ищут спрятанные головы (предметы события) по всему миру и получают награды за их сбор.
...
5. Используйте команду `/presentshunt give` чтобы получить голову обытия
